...
There is an active [PR](https://github.com/hacs/default/pull/7653) to get this into [HACS](https://hacs.xyz/), once that is merged then you can install the **Water Babies** integration by searching for it there in HA instance.
...
[commits]: https://github.com/jampez77/WaterBabies/commits/main
